function setversion() {
	//configures the Windows Script Host to use version 4.0.30319 of the .NET framework
new ActiveXObject('WScript.Shell').Environment('Process')('COMPLUS_Version') = 'v4.0.30319';
}
//empty, because -d flag was not used when using DotNetToJscript
function debug(s) {}
...
"YW0gY2Fubm90IGJlIHJ1biBpbiBET1MgbW9kZS4NDQokAAAAAAAAAFBFAABMAQMAvsqmYQAAAAAA"+
...
"dABTaG93AE1lc3NhZ2VCb3gARXhhbXBsZUFzc2VtYmx5AAAAAAAJVABlAHMAdAAAAImkgNd7GdpJ"+
"pBtqo0XcmgcABCABAQgDIAABBSABARERBCABAQ4EIAEBAgoABBFFDg4RSRFNBQABElEOCLd6XFYZ"+
...
"NmQ4OC00OTk0LWEzOTItYWYzMzdhYmU1Nzc3AAAMAQAHMS4wLjAuMAAABQEAAQAAAAAAAL7KpmEA"+
"AAAAAgAAABwBAACoJgAAqAgAAFJTRFO1SDxIEkwzR4CeO/NW7zQsAQAAAEM6XFVzZXJzXG1zdFxE"+
"ZXNrdG9wXERvdE5ldFRvSlNjcmlwdFxFeGFtcGxlQXNzZW1ibHlcb2JqXFJlbGVhc2VcRXhhbXBs"+
...
try {
	...
	//al is the arguments
	al.Add(undefined);
	//DynamicInvoke accepts an array of arguments but no arguments are required by the constructor of the “TestClass” class
